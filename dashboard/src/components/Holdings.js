...
// import { VerticalGraph } from "./VerticalGraph";
// import { holdings } from "../data/data"; // imported JSON data
...
//       {/* Remove this: <pre>{JSON.stringify(allHoldings, null, 2)}</pre> */}
...
const Holdings = () => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:3002/allHoldings") // ✅ CORRECT endpoint
      .then((res) => {
